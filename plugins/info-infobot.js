...
🔮꙰᠁❥ 𝙎𝙪𝙗-𝘽𝙤𝙩𝙨: ${modejadibot ? "activado" : "desactivado"}`
 ...
 conn.sendMessage(m.chat, { text: info, contextInfo: { externalAdReply: { title: packname, body: '𝘗𝘈𝘚𝘈𝘓𝘈 𝘊𝘏𝘐𝘋𝘖', thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/usxr_angelito', mediaType: 1, renderLargerThumbnail: true }}})
