...
❏ *_Enviando ${additionalText}, aguarde un momento．．．_*`.trim();
  ...
  try {
    ...
    try {
      ...
      await conn.sendMessage(m.chat, {video: {url: mediaa.result}, fileName: `error.mp4`, caption: `_MichiBot_`, thumbnail: mediaa.thumb, mimetype: 'video/mp4'}, {quoted: m});
    } catch {
      try {
